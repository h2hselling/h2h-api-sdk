...
export type External$WorkflowsListResponseItem = {
  ...
  [additionalProperty: string]:
    ...
    | string
    | string
    | External$WorkflowsListResponseItem
    | null
    | undefined;
};
 ...
 */
const SchemaIn$WorkflowsListResponseItem: z.ZodType<
  WorkflowsListResponseItem, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
 ...
 */
const SchemaOut$WorkflowsListResponseItem: z.ZodType<
  External$WorkflowsListResponseItem, // output type of this zod object
  z.ZodTypeDef,
  WorkflowsListResponseItem // the object to be transformed
> = z
  .object({
    createdAt: z.string(),
    description: z.string(),
...
export const Schemas$WorkflowsListResponseItem = {
