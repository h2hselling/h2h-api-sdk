 ...
 */
const SchemaIn$WorkflowsGetResponse: z.ZodType<
  WorkflowsGetResponse, // output type of this zod object
  z.ZodTypeDef,
  unknown
> = z
  .object({
 ...
 */
const SchemaOut$WorkflowsGetResponse: z.ZodType<
  External$WorkflowsGetResponse, // output type of this zod object
  z.ZodTypeDef,
  WorkflowsGetResponse // the object to be transformed
> = z
  .object({
    createdAt: z.string(),
    description: z.string(),
...
export const Schemas$WorkflowsGetResponse = {
